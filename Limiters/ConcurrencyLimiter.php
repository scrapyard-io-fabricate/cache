...
namespace Fabricate\Cache\Limiters;
...
class ConcurrencyLimiter
{
     ...
     *
     * @var \Fabricate\Contracts\Cache\LockProvider
     */
    protected $store;
     ...
     *
     * @param  \Fabricate\Contracts\Cache\LockProvider  $store
     * @param  string  $name
     * @param  int  $maxLocks
     ...
     * @return mixed
     *
     * @throws \Fabricate\Cache\Limiters\LimiterTimeoutException
     * @throws \Throwable
     */
     ...
     *
     * @param  string  $id
     * @return \Fabricate\Contracts\Cache\Lock|false
     */
     ...
     * Release the lock.
     *
     * @param  \Fabricate\Contracts\Cache\Lock  $lock
     * @return void
     */
